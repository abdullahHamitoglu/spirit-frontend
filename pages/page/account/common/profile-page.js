                                    ...
                                    <Form className="theme-form" onSubmit={handleSubmit} >
                                        <Row>
                                            ...
                                            <Col md="6" className='search-box'>
                                                ...
                                                <select className="form-select form-control py-2" size="1">
                                            ...
                                            <Col md="12">
                                                <button className={`btn btn-sm mt-4 btn-solid ${isSubmitting && values == user ? 'disabled' : ''}`} type="submit" disabled={isSubmitting}>{isSubmitting ? t('loading') : t('save')}</button>
                                            </Col>
                                        </Row>
                                    </Form>
                                )}
